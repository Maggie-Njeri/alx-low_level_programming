...
/**
 * create_buffer -is used to allocate 1024 bytes for a buffer
...
/**
 * close_file - is used to close the file descriptors
 ...
 * Return: 0 on success
 * and on Failure: exit code 97 - If the argument count is incorrect
